...
parser.add_argument("-i", "--input", type=str, default="hmumu/hmumu_bdt_model.pkl", help="Input pkl file")
parser.add_argument("-o", "--outDir", type=str, default="/home/submit/jaeyserm/public_html/fccee/higgs_rare_mumu/bdt_xgboost/", help="Output directory")
