...
variables = ['hmumu_m', 'hmumu_p', 'dijet_p', 'jet1_p', 'jet2_p', 'muon1_p', 'muon2_p', 'acoplanarity', 'acolinearity', 'zqq_mass_tot_m', 'zqq_mass_tot_p']
weight_sf = 1e9
sig_df = load_process("hmumu/tree_wzp6_ee_Hmumu_ecm240.root", variables, weight_sf=weight_sf, target=1)
bkg_df = load_process("hmumu/tree_p8_ee_ZZ_ecm240.root", variables, weight_sf=weight_sf)
...
print("Export model")
fOutName = "hmumu/hmumu_bdt_model.root"
...
pickle.dump(save, open("hmumu/hmumu_bdt_model.pkl", "wb"))
