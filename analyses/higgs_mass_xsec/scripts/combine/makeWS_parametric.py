...
if __name__ == "__main__":
    ...
    topRight = "#sqrt{s} = %s GeV, 1 ab^{#minus1}" % (args.ecm)
    ...
    outDir = "/work/submit/jaeyserm/public_html/fccee/higgs_mass_xsec/%s/combine/%s/base_parametric/%s_cat%d_ecm%s/" % (args.tag, mode, flavor, cat, args.ecm)
