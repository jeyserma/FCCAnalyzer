...
if __name__ == "__main__":
    ...
    if args.flavor == "mumu": 
        ...
        bes = {"name": "KKMCee_bes", "datadir": "/eos/user/j/jaeyserm/output_bes.root",  "xsec": 1}
        nobes = {"name": "KKMCee_nobes", "datadir": "/eos/user/j/jaeyserm/output_nobes.root",  "xsec": 1}
    ...
    result = functions.build_and_run(datasets, build_graph, "tmp/validation_kkmcee_%s.root" % args.flavor, maxFiles=args.maxFiles)
