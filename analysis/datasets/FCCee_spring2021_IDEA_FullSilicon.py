...
def getDatasets(filt=None):
    ...
    ## signal samples
    datasets.append({
        "name"      : "wzp6_ee_mumuH_ecm240_FS",
        "datadir"   : "%s/wzp6_ee_mumuH_ecm240" % baseDir,
        "xsec"      : 0.0067643	
    })
    
    datasets.append({
        "name"      : "wzp6_ee_mumuH_mH-lower-50MeV_ecm240_FS",
        "datadir"   : "%s/wzp6_ee_mumuH_mH-lower-50MeV_ecm240" % baseDir,
        "xsec"      : 	0.0067738
    })
    
    datasets.append({
        "name"      : "wzp6_ee_mumuH_mH-lower-100MeV_ecm240_FS",
        "datadir"   : "%s/wzp6_ee_mumuH_mH-lower-100MeV_ecm240" % baseDir,
        "xsec"      : 0.0067849
    })
    
    datasets.append({
        "name"      : "wzp6_ee_mumuH_mH-higher-100MeV_ecm240_FS",
        "datadir"   : "%s/wzp6_ee_mumuH_mH-higher-100MeV_ecm240" % baseDir,
        "xsec"      : 0.0067393
    })
    
    datasets.append({
        "name"      : "wzp6_ee_mumuH_mH-higher-50MeV_ecm240_FS",
